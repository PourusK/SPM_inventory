...
export default async function FleetPage() {
  const vessels = await listVessels("main_fleet");

  return (
    <div className="flex flex-col gap-4">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-semibold">Main Fleet</h1>
          <p className="text-sm text-muted-foreground">
            Vessels currently owned and trading, with their machinery inventory.
          </p>
        </div>
        <VesselFormDialog
          sourceType="main_fleet"
          trigger={
            <Button>
